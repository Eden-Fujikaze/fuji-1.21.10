...
public class Tracer {
    public static void drawTracer(MatrixStack matrices, Vec3d targetPos, Vec3d cameraPos,
            VertexConsumerProvider providers, int argbColor) {
        ...
        matrices.push();
        var camera = GeneralUtils.getCamera();
