...
// public class copy implements ClientModInitializer {

// public static final KeyBinding.Category FUJI_CATEGORY =
// KeyBinding.Category.create(Identifier.of("fuji", "fuji"));
...
// "key.fuji.open_screen", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_G,
// FUJI_CATEGORY));
// bazaarBot = KeyBindingHelper.registerKeyBinding(new KeyBinding(
// "key.fuji.bazaar_bot", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_H,
// FUJI_CATEGORY));
...
// // ── HUD ───────────────────────────────────────────────────────────────
// HudElementRegistry.addLast(Identifier.of("fuji", "bazaar_status"), (ctx,
// tick) -> {
// MinecraftClient mc = MinecraftClient.getInstance();
// if (mc.world == null)
// return;
// String text = BazaarWorker.isEnabled() ? "Bazaar Bot: ON" : "Bazaar Bot:
// OFF";
// int color = BazaarWorker.isEnabled() ? 0xFF00FF00 : 0xFFFF0000;
// ctx.drawTextWithShadow(mc.textRenderer, text, 5, 80, color);
// });

// HudElementRegistry.addLast(Identifier.of("fuji", "target_distances"), (ctx,
// tick) -> {
// MinecraftClient mc = MinecraftClient.getInstance();
...
// if (pos == null)
// continue;
// double dist = new Vec3d(mc.player.getX(), mc.player.getY(),
// mc.player.getZ()).distanceTo(pos);
